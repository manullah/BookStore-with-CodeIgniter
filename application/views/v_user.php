			...
			<table class="table" id="example" ui-options=ui-options="{
				...
				<tbody style="background-color: #CFD8DC;">
					...
					<tr>
						...
						<td><?=$user->level?></td>
						<td>
							<a href="#edit" onclick="edit('<?=$user->kode_user?>')" class="btn btn-success" data-toggle="modal">Edit</a>
							<a href="<?=base_url('index.php/user/hapus/'.$user->kode_user)?>" onclick="return confirm('Apakah anda yakin untuk menghapusnya?')" class="btn btn-danger">Delete</a>
						</td>
					</tr>
				<?php endforeach ?>
				</tbody>
				...
				<form action="<?=base_url('index.php/user/tambah')?>" method="post">
					<div class="modal-body">
						<div class="form-group row">
							<div class="col-sm-3 offset-1"><label>Nama User</label></div>
							<div class="col-sm-7">
